  ...
  return (
    <div className='font-["Space_Grotesk"] max-w-130 bg-ed-800 flex flex-col gap-5 p-2'>
      <div className='flex justify-between items-end'>
        <span className='block font-semibold text-[1.3rem]'>{title}</span>
        <span className={`block text-[0.8rem] font-semibold`} style={{color:module === "IN FILTRATION" ? "#e9c44991" : "#6d6a6ac9"}}>{module}</span>
      </div>
